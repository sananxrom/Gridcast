...
const REASONS: Record<string, string> = {
  ...
  no_playable_asset: 'No playable media is available.',
  creative_duration_outside_limits: 'Creative duration is outside this screen’s minimum or maximum.',
  budget_exhausted: 'Budget reached. Paid delivery is stopped.',
